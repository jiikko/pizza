...
Rails.application.config.sorcery.configure do |config|
  ...
  #
  config.google.key = Rails.application.secrets.oauth['google']['key']
  config.google.secret = Rails.application.secrets.oauth['google']['secret']
  config.google.callback_url = Rails.application.secrets.oauth['google']['callback_url']
